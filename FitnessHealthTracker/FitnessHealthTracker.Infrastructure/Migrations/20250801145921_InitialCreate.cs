        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CaloriesPerHundredGrams = table.Column<int>(type: "int", nullable: false),
                    ProteinsPerHundredGrams = table.Column<float>(type: "real", nullable: false),
                    FatsPerHundredGrams = table.Column<float>(type: "real", nullable: false),
                    CarbohydratesPerHundredGrams = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealNutrients", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UserParameters_ParametersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthParameters_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Meals_MealNutrients_NutrientsId",
                        column: x => x.NutrientsId,
                        principalTable: "MealNutrients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AimValue = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ParametersId",
                table: "AspNetUsers",
                column: "ParametersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthParameters_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealHistories_UserId",
                table: "MealHistories",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Meals_NutrientsId",
                table: "Meals",
                column: "NutrientsId");
